...
uilist = { ...
    ...
    {} ...
    {'style' 'text' 'string' 'What to do with RR artifacts:' 'fontweight' 'bold' } {'style' 'popupmenu' 'string' rrArtMethod 'enable' 'on' 'value' 1 'tag' 'rr_correct'} ...
    {} ...
    ...
    ...
    {'style' 'checkbox' 'string' ' Save outputs' 'fontweight' 'bold' 'tag' 'vis' 'value' 1} {} ...
    };
...
if ~isempty(params.rr_correct)
    switch params.rr_correct
        case 1
            params.rr_correct = 'pchip';  % pchip or spline as default
        case 2 
