...
cleanEEG = {'No (already processed; recommended)' 'Yes (using default parameters; not recommended)'};
...
uilist = { ...
    ...
    ...
    {'style' 'checkbox' 'tag' 'vis_cleaning' 'string' ' Visualize preprocessing plots (recommended)' 'fontweight' 'bold' 'value' 1} {} ...
    ...
