...
if strcmp(params.analysis, 'hep') && strcmp(params.heart_signal, 'ecg')
    ...
    uilist = { ...
        ...
        {} {'style' 'text' 'string' 'Interpolate EEG channels after removal' } {'style' 'popupmenu' 'string' eeginterp 'tag' 'eeg_interp' 'enable' 'off' 'userdata' 'clean_eeg' }  ...
...
uilist = {
    ...
    {} ...
    {'style' 'text' 'string' 'Normalize power' } {'style' 'popupmenu' 'string' hrvnorm 'tag' 'hrv_normc'}  ...
    };
uigeom = {
    [.2 .3]
    .3
