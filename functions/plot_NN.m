...
function plot_NN(sig_t,sig_filt,RR_t,RR,Rpeaks,NN_t,NN,flagged)
...
try
    ...
    scrollplot({sig_t,sig_filt,'color','#0072BD'},{RR_t,sig_filt(Rpeaks),'.','MarkerSize',10,'color','#D95319'}, {'X'},{'Time (s)'},winSize);
    scroll = true;
catch
