...
function [bounds, peak] = get_freqBounds(pwr, f, fs, w, winSize, mpow, norm)
...
% mpow = 1;       % error bound (SD) threshold to differentiate peaks from 
%                 % background spectral noise (default = 1) --> change to 0
%                 % .5 or 0.25 for other bands.
